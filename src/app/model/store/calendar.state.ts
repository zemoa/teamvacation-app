    ...
    async saveVacation(ctx: StateContext<CalendarStateModel>) {
        ...
        if(askResultDto) {
            ...
            askResultDto.vacationList.forEach(vacation => {
                ...
                Utils.modifyIntoList(modifiedDays,
                                     modifiedDay => modifiedDay.date.getTime() === convertedDay.date.getTime(),
                                     value => {
                                         const foundDay: Day = {
                                             date: value.date,
                                             am: {
                                                 ...value.am,
                                                 id: convertedDay.am.id
                                             },
                                             pm: {
                                                 ...value.pm,
                                                 id: convertedDay.pm.id
                                             }
                                         };
                                         return foundDay;
                                     });
          ...
          !modifiedDay.pm.type || modifiedDay.pm.type === VacationType.UNKNOWN) {
            ...
            this.vacationService.sendMail(askResultDto);
        } else {
